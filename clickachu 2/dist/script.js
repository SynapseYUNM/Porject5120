const Bolts = Vue.component('bolts', {
  ...
  <div class="c-bolts absolute top-neg4 left-0 right-0 center">
    <span :class="classes.bolt" :style="styles.bolt" class="h1 bold">Do</span>
    <span :class="classes.bolt" :style="styles.bolt" class="h1 bold">the</span>
    <span :class="classes.bolt" :style="styles.bolt" class="h1 bold">Quiz？</span>
  </div>`,
  computed: {
    styles() {
      return {
